...
do
  ...
  do
    ...
    do
      ...
      line=`"${toolCmd}" test -n 1044 -g ../../Validation.sad -w "${weightsFile}" -I .. ${toolFlags} | grep "running average" | tail -n 1`
    ...
    line=`"${toolCmd}" test -n 1044 -g ../../Test.sad -w "${bestWeightsFile}" -I .. ${toolFlags} | grep "mean residual" | tail -n 1`
