...
do
  ...
  validationGraph="../../Validation${layers}.sad"
  testGraph="../../Test${layers}.sad"
  ...
  do
    ...
    do
      ...
      line=`"${toolCmd}" test -n 1044 -g "${validationGraph}" -w "${weightsFile}" -I .. ${toolFlags} | grep "running average" | tail -n 1`
    ...
    line=`"${toolCmd}" test -n 1044 -g "${testGraph}" -w "${bestWeightsFile}" -I .. ${toolFlags} | grep "mean residual" | tail -n 1`
