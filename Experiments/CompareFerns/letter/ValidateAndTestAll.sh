...
do
  ...
  do
    ...
    do
      ...
      #line=`"${toolCmd}" test -t double -n 4000 -g ../../Validation.sad -I ../../../hackedSubgraphs -I .. ${toolFlags} -w "${weightsFile}" | grep "running average" | tail -n 1`
      #loss=`echo "${line}" | awk '{ gsub("\r",""); print $NF }'`
      line=`"${toolCmd}" test -t double -n 4000 -g ../../Validation.sad -I ../../../hackedSubgraphs -I .. ${toolFlags} -w "${weightsFile}" | grep "running accuracy" | tail -n 1`
    ...
    line=`"${toolCmd}" test -t double -n 4000 -g ../../Test.sad -I ../../../hackedSubgraphs -I .. ${toolFlags} -w "${bestWeightsFile}" | grep "running accuracy" | tail -n 1`
